...
void Scene::Create(AppState& appState, VkCommandBufferAllocateInfo& commandBufferAllocateInfo, VkCommandBuffer& setupCommandBuffer, VkCommandBufferBeginInfo& commandBufferBeginInfo, VkSubmitInfo& setupSubmitInfo, Instance& instance, VkFenceCreateInfo& fenceCreateInfo, struct android_app* app)
{
	...
	appState.Scene.surfaceAttributes.vertexAttributes.resize(5);
	appState.Scene.surfaceAttributes.vertexBindings.resize(2);
	appState.Scene.surfaceAttributes.vertexAttributes[0].format = VK_FORMAT_R32G32B32_SFLOAT;
	appState.Scene.surfaceAttributes.vertexBindings[0].stride = 3 * sizeof(float);
	appState.Scene.surfaceAttributes.vertexAttributes[1].location = 1;
	appState.Scene.surfaceAttributes.vertexAttributes[1].binding = 1;
	appState.Scene.surfaceAttributes.vertexAttributes[1].format = VK_FORMAT_R32G32B32A32_SFLOAT;
	appState.Scene.surfaceAttributes.vertexAttributes[2].location = 2;
	appState.Scene.surfaceAttributes.vertexAttributes[2].binding = 1;
	appState.Scene.surfaceAttributes.vertexAttributes[2].format = VK_FORMAT_R32G32B32A32_SFLOAT;
	appState.Scene.surfaceAttributes.vertexAttributes[2].offset = 4 * sizeof(float);
	appState.Scene.surfaceAttributes.vertexAttributes[3].location = 3;
	appState.Scene.surfaceAttributes.vertexAttributes[3].binding = 1;
	appState.Scene.surfaceAttributes.vertexAttributes[3].format = VK_FORMAT_R32G32B32A32_SFLOAT;
	appState.Scene.surfaceAttributes.vertexAttributes[3].offset = 8 * sizeof(float);
	appState.Scene.surfaceAttributes.vertexAttributes[4].location = 4;
	appState.Scene.surfaceAttributes.vertexAttributes[4].binding = 1;
	appState.Scene.surfaceAttributes.vertexAttributes[4].format = VK_FORMAT_R32G32B32A32_SFLOAT;
	appState.Scene.surfaceAttributes.vertexAttributes[4].offset = 12 * sizeof(float);
	appState.Scene.surfaceAttributes.vertexBindings[1].binding = 1;
	appState.Scene.surfaceAttributes.vertexBindings[1].stride = 16 * sizeof(float);
	appState.Scene.surfaceAttributes.vertexBindings[1].inputRate = VK_VERTEX_INPUT_RATE_INSTANCE;
	appState.Scene.surfaceAttributes.vertexInputState.sType = VK_STRUCTURE_TYPE_PIPELINE_VERTEX_INPUT_STATE_CREATE_INFO;
	appState.Scene.surfaceAttributes.vertexInputState.vertexBindingDescriptionCount = appState.Scene.surfaceAttributes.vertexBindings.size();
	appState.Scene.surfaceAttributes.vertexInputState.pVertexBindingDescriptions = appState.Scene.surfaceAttributes.vertexBindings.data();
	appState.Scene.surfaceAttributes.vertexInputState.vertexAttributeDescriptionCount = appState.Scene.surfaceAttributes.vertexAttributes.size();
	appState.Scene.surfaceAttributes.vertexInputState.pVertexAttributeDescriptions = appState.Scene.surfaceAttributes.vertexAttributes.data();
	appState.Scene.surfaceAttributes.inputAssemblyState.sType = VK_STRUCTURE_TYPE_PIPELINE_INPUT_ASSEMBLY_STATE_CREATE_INFO;
	appState.Scene.surfaceAttributes.inputAssemblyState.topology = VK_PRIMITIVE_TOPOLOGY_TRIANGLE_STRIP;
	appState.Scene.spriteAttributes.vertexAttributes.resize(6);
	appState.Scene.spriteAttributes.vertexBindings.resize(3);
	appState.Scene.spriteAttributes.vertexAttributes[0].format = VK_FORMAT_R32G32B32_SFLOAT;
	appState.Scene.spriteAttributes.vertexBindings[0].stride = 3 * sizeof(float);
	appState.Scene.spriteAttributes.vertexAttributes[1].location = 1;
	appState.Scene.spriteAttributes.vertexAttributes[1].binding = 1;
	appState.Scene.spriteAttributes.vertexAttributes[1].format = VK_FORMAT_R32G32_SFLOAT;
	appState.Scene.spriteAttributes.vertexBindings[1].binding = 1;
	appState.Scene.spriteAttributes.vertexBindings[1].stride = 2 * sizeof(float);
	appState.Scene.spriteAttributes.vertexAttributes[2].location = 2;
	appState.Scene.spriteAttributes.vertexAttributes[2].binding = 2;
	appState.Scene.spriteAttributes.vertexAttributes[2].format = VK_FORMAT_R32G32B32A32_SFLOAT;
	appState.Scene.spriteAttributes.vertexAttributes[3].location = 3;
	appState.Scene.spriteAttributes.vertexAttributes[3].binding = 2;
	appState.Scene.spriteAttributes.vertexAttributes[3].format = VK_FORMAT_R32G32B32A32_SFLOAT;
	appState.Scene.spriteAttributes.vertexAttributes[3].offset = 4 * sizeof(float);
	appState.Scene.spriteAttributes.vertexAttributes[4].location = 4;
	appState.Scene.spriteAttributes.vertexAttributes[4].binding = 2;
	appState.Scene.spriteAttributes.vertexAttributes[4].format = VK_FORMAT_R32G32B32A32_SFLOAT;
	appState.Scene.spriteAttributes.vertexAttributes[4].offset = 8 * sizeof(float);
	appState.Scene.spriteAttributes.vertexAttributes[5].location = 5;
	appState.Scene.spriteAttributes.vertexAttributes[5].binding = 2;
	appState.Scene.spriteAttributes.vertexAttributes[5].format = VK_FORMAT_R32G32B32A32_SFLOAT;
	appState.Scene.spriteAttributes.vertexAttributes[5].offset = 12 * sizeof(float);
	appState.Scene.spriteAttributes.vertexBindings[2].binding = 2;
	appState.Scene.spriteAttributes.vertexBindings[2].stride = 16 * sizeof(float);
	appState.Scene.spriteAttributes.vertexBindings[2].inputRate = VK_VERTEX_INPUT_RATE_INSTANCE;
	appState.Scene.spriteAttributes.vertexInputState.sType = VK_STRUCTURE_TYPE_PIPELINE_VERTEX_INPUT_STATE_CREATE_INFO;
	appState.Scene.spriteAttributes.vertexInputState.vertexBindingDescriptionCount = appState.Scene.spriteAttributes.vertexBindings.size();
	appState.Scene.spriteAttributes.vertexInputState.pVertexBindingDescriptions = appState.Scene.spriteAttributes.vertexBindings.data();
	appState.Scene.spriteAttributes.vertexInputState.vertexAttributeDescriptionCount = appState.Scene.spriteAttributes.vertexAttributes.size();
	appState.Scene.spriteAttributes.vertexInputState.pVertexAttributeDescriptions = appState.Scene.spriteAttributes.vertexAttributes.data();
	appState.Scene.spriteAttributes.inputAssemblyState.sType = VK_STRUCTURE_TYPE_PIPELINE_INPUT_ASSEMBLY_STATE_CREATE_INFO;
	appState.Scene.spriteAttributes.inputAssemblyState.topology = VK_PRIMITIVE_TOPOLOGY_TRIANGLE_STRIP;
	...
	appState.Scene.surfaces.stages.resize(2);
	appState.Scene.surfaces.stages[0].sType = VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO;
	appState.Scene.surfaces.stages[0].stage = VK_SHADER_STAGE_VERTEX_BIT;
	appState.Scene.surfaces.stages[0].module = appState.Scene.surfaceVertex;
	appState.Scene.surfaces.stages[0].pName = "main";
	appState.Scene.surfaces.stages[1].sType = VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO;
	...
	graphicsPipelineCreateInfo.stageCount = appState.Scene.surfaces.stages.size();
	graphicsPipelineCreateInfo.pStages = appState.Scene.surfaces.stages.data();
	graphicsPipelineCreateInfo.pVertexInputState = &appState.Scene.surfaceAttributes.vertexInputState;
	graphicsPipelineCreateInfo.pInputAssemblyState = &appState.Scene.surfaceAttributes.inputAssemblyState;
	...
	graphicsPipelineCreateInfo.layout = appState.Scene.surfaces.pipelineLayout;
	graphicsPipelineCreateInfo.renderPass = appState.RenderPass;
	VK(appState.Device.vkCreateGraphicsPipelines(appState.Device.device, appState.Context.pipelineCache, 1, &graphicsPipelineCreateInfo, nullptr, &appState.Scene.surfaces.pipeline));
	appState.Scene.fences.stages.resize(2);
	appState.Scene.fences.stages[0].sType = VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO;
	appState.Scene.fences.stages[0].stage = VK_SHADER_STAGE_VERTEX_BIT;
	appState.Scene.fences.stages[0].module = appState.Scene.surfaceVertex;
	...
	graphicsPipelineCreateInfo.pStages = appState.Scene.fences.stages.data();
	graphicsPipelineCreateInfo.layout = appState.Scene.fences.pipelineLayout;
	VK(appState.Device.vkCreateGraphicsPipelines(appState.Device.device, appState.Context.pipelineCache, 1, &graphicsPipelineCreateInfo, nullptr, &appState.Scene.fences.pipeline));
	...
	appState.Scene.sprites.stages[0].module = appState.Scene.spriteVertex;
	...
	appState.Scene.sprites.stages[1].module = appState.Scene.spriteFragment;
	...
	graphicsPipelineCreateInfo.pVertexInputState = &appState.Scene.spriteAttributes.vertexInputState;
	graphicsPipelineCreateInfo.pInputAssemblyState = &appState.Scene.spriteAttributes.inputAssemblyState;
