...
void main(void)
{
	...
	int lightIndex = attributeOffset + gl_VertexIndex * 4;
	fragmentAttributes = vec4(lightData[lightIndex], lightData[lightIndex + 1], lightData[lightIndex + 2], lightData[lightIndex + 3]) / vec4(32, 32, 32, 1);
}
