...
void IN_MouseMove (usercmd_t *cmd)
{
    ...
    auto centerX = (windowRect.left + windowRect.right) / 2;
    auto centerY = (windowRect.top + windowRect.bottom) / 2;
    if (!appState.cursorRelocated)
    {
        mx = 0;
        my = 0;
    }
    ...
    {
        mx = ci.ptScreenPos.x - centerX;
        my = ci.ptScreenPos.y - centerY;
    }
    SetCursorPos(centerX, centerY);
    appState.cursorRelocated = true;
    if (m_filter.value)
    {
