...
void main()
{
	...
	vec2 lightmapCoordsDelta = floor((fragmentCoords.xy - lightmapCoords) * 16) / 16;
	...
	if (lowColormapped.x == 255 || lowNextColormapped.x == 255 || highColormapped.x == 255 || highNextColormapped.x == 255)
	{
		discard;
	}
